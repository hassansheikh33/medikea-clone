...
export default function Difference() {
  return (
    <div className="mt-14">
      ...
      <div className="flex flex-wrap justify-center gap-x-8  customSm:gap-y-4">
        {cards.map((item) => {
          return (
            <div
              key={item.title}
              className="w-[22%] h-60 bg-cardBg p-4 flex flex-col justify-end relative overflow-hidden customSm:w-[90%]"
            >
